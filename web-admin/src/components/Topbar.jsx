...
const Topbar = () => {
  ...
  return (
    <header className="topbar glass-panel" style={{ position: 'relative', border: 'none', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: 0, height: '70px' }}>
      ...
      <div style={{ position: 'absolute', right: '20px', top: '50%', transform: 'translateY(-50%)' }}>
        ...
        {showProfile && (
          <div className="glass-panel" style={{
            ...
            border: '1px solid rgba(255, 255, 255, 0.2)', zIndex: 1000, overflow: 'hidden'
          }}>
            ...
            <div style={{ padding: '12px' }}>
              <button style={{ width: '100%', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '10px', background: 'none', border: 'none', color: '#475569', fontSize: '0.9rem', fontWeight: 500, cursor: 'pointer', borderRadius: '8px', textAlign: 'left', transition: 'all 0.2s' }}>
              ...
              <button onClick={() => navigate('/login')} style={{ width: '100%', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '10px', background: 'none', border: 'none', color: '#EF4444', fontSize: '0.9rem', fontWeight: 600, cursor: 'pointer', borderRadius: '8px', textAlign: 'left', transition: 'all 0.2s' }}>
